...
import com.example.calyx.mykeep.Reminder.ReminderActivity;

import java.util.ArrayList;
import java.util.UUID;

public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "com.calyx.mykeep.todonotificationservicetext";
    public static final String TODOUUID = "com.calyx.mykeep.todonotificationserviceuuid";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (ToDoItem toDoItem : mToDoItems) {
            if (toDoItem.getIdentifier().equals(mTodoUUID)) {
                mItem = toDoItem;
                break;
            }
        }
...
//        i.putExtra(TodoNotificationService.TODOUUID, mTodoUUID);
        i.putExtra(MainFragment.TODOITEM, mItem);
